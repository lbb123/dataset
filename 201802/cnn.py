...
from keras.layers.convolutional import Convolution2D, MaxPooling2D, ZeroPadding2D,Conv2D,ZeroPadding3D
...
plt_save_fg=1
png=''
url = '/home/ubuntu/Desktop/RML_dataset/dataset_1/RML2018.2a_awgn.dat'
Xd = cPickle.load(open(url,'rb'))
...
filepath = 'convmodrecnets_CNN2_0.6.wts.h5'
...
plt.legend()
png=str(plt_save_fg)+".png"
plt_save_fg = plt_save_fg+1
plt.savefig(png)
...
fd = open('results_cnn2_d0.6.dat','wb')
...
plt.title("CNN2 Classification Accuracy on RadioML 2018.2 Alpha")
png = str(plt_save_fg) + ".png"
plt_save_fg = plt_save_fg + 1
plt.savefig(png)